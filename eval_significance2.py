...
if __name__ == "__main__":
    ...
    r = run_ir_significance(
        RUN_LOG_DIR / "eval_2026-08-05T21-29-58+00-00_fixed_vector.json",
        RUN_LOG_DIR / "eval_2026-08-05T21-47-32+00-00_recursive_vector.json",
        label_a="fixed", label_b="recursive",
    )
    exp1_results.extend(r.values())
    r = run_ragas_significance(
        RUN_LOG_DIR / "eval_2026-08-05T21-29-58+00-00_fixed_vector_ragas.csv",
        RUN_LOG_DIR / "eval_2026-08-05T21-47-32+00-00_recursive_vector_ragas.csv",
        label_a="fixed", label_b="recursive",
    )
    exp1_results.extend(r.values())
    ...
    NEW_VECTOR_JSON = RUN_LOG_DIR / "eval_2026-08-05T21-47-32+00-00_recursive_vector.json"
    NEW_HYBRID_JSON = RUN_LOG_DIR / "eval_2026-08-05T22-01-47+00-00_recursive_hybrid.json"
    NEW_VECTOR_RAGAS = RUN_LOG_DIR / "eval_2026-08-05T21-47-32+00-00_recursive_vector_ragas.csv"
    NEW_HYBRID_RAGAS = RUN_LOG_DIR / "eval_2026-08-05T22-01-47+00-00_recursive_hybrid_ragas.csv"
